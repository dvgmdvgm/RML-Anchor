...
| `/sleep` | Finalizar sesión, archivar en historial |
...
| `/anchor_briefing` | Resumen completo del proyecto (13 categorías) |
| `/anchor_backup` | Crear copia de seguridad (para transferir) |
| `/anchor_restore` | Restaurar desde copia ZIP |
